...
export default function WizardInventarioGEE() {
  ...
  return (
    <div style={{ maxWidth: 700, margin: '0 auto', padding: 32, background: '#fff', borderRadius: 12, boxShadow: '0 2px 16px #0001' }}>
      <h2 style={{ textAlign: 'center', color: '#388e3c', marginBottom: 0 }}>Inventário de Emissões de GEE</h2>
      <div style={{ textAlign: 'right', marginBottom: 8 }}>
        <span style={{ color: '#888', fontSize: 13, marginRight: 12 }}>Empresa: <b>{usuario.empresa}</b></span>
        <button type="button" onClick={handleLogout} style={{ padding: '4px 14px', borderRadius: 5, border: 'none', background: '#d32f2f', color: '#fff', fontWeight: 600, cursor: 'pointer', fontSize: 13 }}>Sair</button>
      </div>
      <ProgressoWizard />
      {/* Feedback visual */}
        ...
        {etapaAtual === 3 && (
          <div>
            ...
            <fieldset style={{ border: '1px solid #ccc', padding: 8, marginBottom: 8 }}>
              ...
              <label>Período de consumo:<br /><input type="text" name="combustivel_periodo" value={dados.combustivel_periodo || ''} onChange={handleChange} style={{ width: '100%' }} /></label><br />
            </fieldset>
            ...
            <fieldset style={{ border: '1px solid #ccc', padding: 8, marginBottom: 8 }}>
              ...
              <label>Período de consumo:<br /><input type="text" name="energia_periodo" value={dados.energia_periodo || ''} onChange={handleChange} style={{ width: '100%' }} /></label><br />
            </fieldset>
            <fieldset style={{ border: '1px solid #ccc', padding: 8, marginBottom: 8 }}>
